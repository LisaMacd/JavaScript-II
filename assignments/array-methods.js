...
// Problem 1 - Determine the average donation
let averageDonation = [];
averageDonation = runners.reduce((tracker, item) => tracker + item.donation, 0);
averageDonation /= runners.length;
console.log(Math.round(averageDonation));
